...
const METHOD_COMMON = [
  ['Bilete AI', 'Pentru o cotă țintă, un optimizator exact caută combinația de selecții (cel mult una pe meci, niciodată aceeași echipă de două ori) cu cea mai mare probabilitate combinată și cota totală în intervalul 0.93–1.12 × țintă. Selecțiile au note A–C, cote reale între 1.08 și 4.0, nu pot fi rambursate și au probabilitate × cotă între 0.95 și 1.05: sub 0.95 pariul este clar prost, peste 1.05 modelul contrazice prețul mai mult decât marja casei, fără dovezi că ar avea dreptate (plafon prudent, nu optim măsurat).'],
